...
- [AWS retry/backoff applied reading lab](https://aws.amazon.com/builders-library/timeouts-retries-and-backoff-with-jitter/) — 2 hours. **Evidence:** Translate each recommendation into a simulator experiment and record the result.
