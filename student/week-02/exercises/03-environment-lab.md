...
**Objective:** Learn HTTP semantics, REST, validation, error models, retries by operating and observing the supplied environment.
...
Read `training-platform/student/cases/week-02-practice.json`. Without running it, predict status, latency/parsing behavior, state, logs, and recovery. Then run:
