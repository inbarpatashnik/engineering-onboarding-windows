...
**Project:** Implement a resilient API client  
...
```powershell
.\training-platform\student\new-case.ps1 -Name my-week-02-case -Mode delay -DelayMs 700 -LearningGoal "Replace with the specific concept being tested"
