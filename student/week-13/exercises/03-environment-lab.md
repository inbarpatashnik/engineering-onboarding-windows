...
**Objective:** Learn system synthesis, incident response, communication, remediation by operating and observing the supplied environment.
...
Read `training-platform/student/cases/week-13-practice.json`. Without running it, predict status, latency/parsing behavior, state, logs, and recovery. Then run:
