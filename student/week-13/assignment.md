...
Follow relevant linked subsections and take working notes. Answer: what problem does this solve, which assumption can fail, and which observable signal would reveal failure? Topics this week: system synthesis, incident response, communication, remediation.
...
1. **Start from an unknown compound failure** — suggested 1.5 hours.
2. **Maintain a timestamped hypothesis log** — suggested 1.5 hours.
3. **Stabilize first, then write a blameless post-incident review** — suggested 1.5 hours.
