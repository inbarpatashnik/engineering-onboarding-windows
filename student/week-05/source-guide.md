# Week 5 source and workshop guide
...
- [Redis developer quick start](https://redis.io/docs/latest/develop/get-started/) — 1–2 hours. **Evidence:** Run the data-structure examples and document which structures fit cache keys and coordination.
