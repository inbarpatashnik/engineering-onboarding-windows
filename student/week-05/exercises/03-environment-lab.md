...
**Objective:** Learn Redis patterns, race conditions, idempotency, locking by operating and observing the supplied environment.
...
Read `training-platform/student/cases/week-05-practice.json`. Without running it, predict status, latency/parsing behavior, state, logs, and recovery. Then run:
