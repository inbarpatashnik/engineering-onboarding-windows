...
**Project:** Add safe caching to the catalog client  
...
```powershell
.\training-platform\student\new-case.ps1 -Name my-week-05-case -Mode delay -DelayMs 700 -LearningGoal "Replace with the specific concept being tested"
