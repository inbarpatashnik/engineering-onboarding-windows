...
Follow relevant linked subsections and take working notes. Answer: what problem does this solve, which assumption can fail, and which observable signal would reveal failure? Topics this week: Kafka concepts, delivery semantics, schemas, consumers.
...
1. **Publish and consume a small event batch** — suggested 1.5 hours.
2. **Create duplicate and poison-message cases** — suggested 1.5 hours.
3. **Restart the consumer and explain offset recovery** — suggested 1.5 hours.
