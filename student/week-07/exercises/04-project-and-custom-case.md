...
**Project:** Create a layered automated test suite  
...
```powershell
.\training-platform\student\new-case.ps1 -Name my-week-07-case -Mode delay -DelayMs 700 -LearningGoal "Replace with the specific concept being tested"
