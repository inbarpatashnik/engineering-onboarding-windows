...
**Objective:** Learn unit, integration, contract, property, and end-to-end testing by operating and observing the supplied environment.
...
Read `training-platform/student/cases/week-07-practice.json`. Without running it, predict status, latency/parsing behavior, state, logs, and recovery. Then run:
