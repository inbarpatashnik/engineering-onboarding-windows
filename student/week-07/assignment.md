...
Follow relevant linked subsections and take working notes. Answer: what problem does this solve, which assumption can fail, and which observable signal would reveal failure? Topics this week: unit, integration, contract, property, and end-to-end testing.
...
1. **Turn one production-like failure into a regression test** — suggested 1.5 hours.
2. **Separate unit, integration, and contract checks** — suggested 1.5 hours.
3. **Make a nondeterministic test deterministic** — suggested 1.5 hours.
