...
**Project:** Threat-model and secure a service endpoint  
...
```powershell
.\training-platform\student\new-case.ps1 -Name my-week-10-case -Mode delay -DelayMs 700 -LearningGoal "Replace with the specific concept being tested"
