...
While reading, answer: what problem does this solve, which assumption can fail, and which observable signal would reveal failure? Topics this week: threat modeling, secrets, authn/authz, input safety.
...
1. **Draw trust boundaries for the simulator** — 40 minutes.
2. **Create malicious-input and missing-authorization cases** — 40 minutes.
3. **Prove secrets and authorization headers never enter logs** — 40 minutes.
...
```powershell
.\training-platform\student\new-case.ps1 -Name my-week-10-case -Mode delay -DelayMs 700
.\training-platform\student\run-case.ps1 -Case my-week-10-case
```
