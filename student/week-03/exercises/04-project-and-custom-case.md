...
**Project:** Design and query a resource catalog  
...
```powershell
.\training-platform\student\new-case.ps1 -Name my-week-03-case -Mode delay -DelayMs 700 -LearningGoal "Replace with the specific concept being tested"
