...
Follow relevant linked subsections and take working notes. Answer: what problem does this solve, which assumption can fail, and which observable signal would reveal failure? Topics this week: relational modeling, indexes, transactions, query plans.
...
1. **Create constraints that reject invalid resources** — suggested 1.5 hours.
2. **Compare query plans before and after an index** — suggested 1.5 hours.
3. **Restart the database and prove committed data survives** — suggested 1.5 hours.
