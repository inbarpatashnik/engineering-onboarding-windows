...
- [Grafana k6 first test](https://grafana.com/docs/k6/latest/get-started/running-k6/) — 2 hours. **Evidence:** Create a repeatable test, add thresholds, and compare median with percentile latency.
