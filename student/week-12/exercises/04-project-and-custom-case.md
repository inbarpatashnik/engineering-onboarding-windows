...
**Project:** Create a safe release runbook  
...
```powershell
.\training-platform\student\new-case.ps1 -Name my-week-12-case -Mode delay -DelayMs 700 -LearningGoal "Replace with the specific concept being tested"
