...
**Objective:** Learn CI/CD, containers, configuration, migrations, rollback by operating and observing the supplied environment.
...
Read `training-platform/student/cases/week-12-practice.json`. Without running it, predict status, latency/parsing behavior, state, logs, and recovery. Then run:
