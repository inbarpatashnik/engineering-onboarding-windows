...
Follow relevant linked subsections and take working notes. Answer: what problem does this solve, which assumption can fail, and which observable signal would reveal failure? Topics this week: CI/CD, containers, configuration, migrations, rollback.
...
1. **Build and run an immutable container image** — suggested 1.5 hours.
2. **Create failed-health-check and incompatible-config cases** — suggested 1.5 hours.
3. **Rehearse a rollback without deleting data** — suggested 1.5 hours.
