...
The student should demonstrate: identify trust boundaries and verify controls. Focus the review on assets, actors, trust boundaries, least privilege, secret handling. Do not reward extra architecture that lacks evidence.
