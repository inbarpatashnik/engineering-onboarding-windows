...
The student should demonstrate: defend schema and index choices with measurements. Focus the review on normalization, constraints, transaction boundaries, measured indexes. Do not reward extra architecture that lacks evidence.
