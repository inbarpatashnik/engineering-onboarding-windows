...
The student should demonstrate: demonstrate correctness under concurrent requests. Focus the review on cache keys, invalidation, atomicity, stampede prevention. Do not reward extra architecture that lacks evidence.
