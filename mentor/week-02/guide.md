...
The student should demonstrate: distinguish client, server, and transient failures. Focus the review on status semantics, validation, timeout budgets, retry eligibility. Do not reward extra architecture that lacks evidence.
