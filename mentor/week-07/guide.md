...
The student should demonstrate: explain what each test catches and misses. Focus the review on test boundaries, deterministic fixtures, contract ownership. Do not reward extra architecture that lacks evidence.
