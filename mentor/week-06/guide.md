...
The student should demonstrate: recover from duplicates and poison messages. Focus the review on consumer offsets, idempotency keys, schema evolution, dead letters. Do not reward extra architecture that lacks evidence, and do not operate or repair the normal environment for the student.
