...
The student should demonstrate: diagnose latency using correlated telemetry. Focus the review on cardinality, correlation IDs, RED/USE signals, sampling. Do not reward extra architecture that lacks evidence.
