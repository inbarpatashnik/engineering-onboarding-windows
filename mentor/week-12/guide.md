...
The student should demonstrate: plan detection, rollback, and data compatibility. Focus the review on immutable artifacts, health gates, migrations, rollback rehearsal. Do not reward extra architecture that lacks evidence.
