...
The student should demonstrate: show before/after evidence without hiding tradeoffs. Focus the review on representative load, bottleneck evidence, percentile latency. Do not reward extra architecture that lacks evidence.
