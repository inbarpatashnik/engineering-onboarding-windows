...
The student should demonstrate: choose a model based on access patterns. Focus the review on access-pattern modeling, consistency, graph traversal limits. Do not reward extra architecture that lacks evidence.
