...
The student should demonstrate: avoid retry storms and bound failure impact. Focus the review on deadline propagation, jitter, circuit states, recovery behavior. Do not reward extra architecture that lacks evidence.
